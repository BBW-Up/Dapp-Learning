...
https://ithelp.ithome.com.tw/articles/10202794 创建后，获取相应的Project ID。

- 为方便代码测试, 在 .env 中放入私钥和 Infura Project ID，格式为 "PRIVATE_KEY=xxxx INFURA_ID=yyyyyyyy", 然后代码自动从中读取, 样例文件可参考 .env.example
